...
// Check if the logout button is clicked and verify the CSRF token
...
// Generate and store the CSRF token after successful login
if (isset($_POST["username"]) && isset($_POST["password"])) {
...
if ($username) {
    ...
    // Display the logout button with the CSRF token
